...
*/
    ...
    public:
        ...
        Data<type::vector<Index>> d_renderPoints1;
        Data<type::vector<Index>> d_renderPoints2;

        Data<type::Vec3f> d_drawShift;
    ...
    private:
        type::vector<Triangle> m_surfaceTriangles;
    ...
    protected:
        ...
        void drawSurfaceTrianglesVonStressColorMap(const core::visual::VisualParams* vparams, const VecCoord& x,
